...
class Detr3DHead(DETRHead):
    ...
    def __init__(self,
        ...
        self.rf_multihead_attn3 = nn.MultiheadAttention(self.embed_dims, 8, dropout=0.1)
        # Implementation of Feedforward model
        self.rf_linear1_3 = nn.Linear(self.embed_dims, 512)  # this 512 is the dimension for the feedforward network
        self.rf_dropout_3 = nn.Dropout(0.1)
        self.rf_linear2_3 = nn.Linear(512, self.embed_dims)

        self.rf_norm1_3 = nn.LayerNorm(self.embed_dims)
        self.rf_norm2_3 = nn.LayerNorm(self.embed_dims)
        self.rf_norm3_3 = nn.LayerNorm(self.embed_dims)
        self.rf_dropout1_3 = nn.Dropout(0.1)
        self.rf_dropout2_3 = nn.Dropout(0.1)
        self.rf_dropout3_3 = nn.Dropout(0.1)
        self.rf_activation_3 = nn.ReLU(inplace=True)
        ...
        self.attention_weights3 = nn.Linear(self.embed_dims,6*4)
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        #++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++    3rd layer
        new_reference_3d_3 = torch.zeros_like(new_reference_3d)
        new_reference_3d_3[..., :2] = tmp2[..., :2]
        ...
        outputs_classes.append(output_final_class3)
        outputs_coords.append(output_final_coord3)
